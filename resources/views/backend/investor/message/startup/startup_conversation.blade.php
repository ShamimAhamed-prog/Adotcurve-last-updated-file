...
@section("investor_profile_content")
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <div class="row">
                <form  class="user col-lg-12 col-md-12" action="{{ route('investor.startup.message.sendMessage') }}" method="post">
                    @csrf
                    ...
                    <div class="container">
                        <h3 class=" text-center">Messaging For Investor To Startup</h3>
                        <div class="messaging">
                            <div class="inbox_msg">
                                <div class="mesgs">
                                    <div class="msg_history">
                                        @foreach($messages as $m)
                                            @if(strcmp($m->sent_by, 'investor'))
