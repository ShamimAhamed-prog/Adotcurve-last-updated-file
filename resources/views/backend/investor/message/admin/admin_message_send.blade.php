...
@section("investor_profile_content")
    <!-- Page Heading -->
    <h1 class="h3 mb-2 text-gray-800">Messages Send Admin</h1>
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <form action="{{route('investor.admin.message.store')}}" method="post">
                @csrf
                <div class="card shadow mb-4">
                    <div class="card-header py-3">
                    ...
                    <div class="card-body">
                        <div class="table-responsive">
                            <table class="table table-bordered table-strip adminTable" id="dataTable" >
                                <thead>
                                <tr>
                                    <th>S/N</th>
                                    <th>Admin name</th>
                                ...
                                @forelse ($admins as $key=>$admin)
                                    <tr>
                                        ...
                                        <td>{{ $admin->email }}</td>
                                        <td>
                                            <input type="checkbox" name="admin_ids[]" class="form-control form-control-sm checkAdmin" value="{{ $admin->id}}">
                                        </td>
                                    </tr>
    ...
    <script>
        ...
        $('.adminTable').on("change", ".checkAdmin", function (event) {

            var status = $('.adminTable :input[type="checkbox"]:checked').length;
