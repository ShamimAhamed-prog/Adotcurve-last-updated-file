...
@section("startup_profile_content")
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <div class="row">
                <form  class="user col-lg-12 col-md-12" action="{{ route('startup.investor.message.sendMessage') }}" method="post">
                    @csrf
                    <input type="hidden" name="startup_id" value="{{ $messages[0]->startup_id }}">
                    <input type="hidden" name="investor_id" value="{{ $messages[0]->investor_id }}">
                    <input type="hidden" name="sent_by" value="startup">
                    <div class="container">
                        <h3 class=" text-center">Messaging For Startup To Investor</h3>
                        <div class="messaging">
                            <div class="inbox_msg">
                                <div class="mesgs">
                                    <div class="msg_history">
                                        @foreach($messages as $m)
                                            @if(strcmp($m->sent_by, 'startup'))
                                            ...
                                            @else
                                                <div class="outgoing_msg">
                                                    <div class="sent_msg">
                                                        ...
                                                        {{--                                                        <span class="time_date"> {{ $m->created_at->diffForHumans() }}   |    June 9</span> </div>--}}
