...
@section("admin_email")
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <div class="row">
                <form  class="user col-lg-12 col-md-12" action="{{ route('admin.investor.message.sendMessage') }}" method="post">
                    @csrf
                    ...
                    <div class="container">
                        <h3 class=" text-center">Messaging For Admin To Investor</h3>
                        <div class="messaging">
                            <div class="inbox_msg">
                                <div class="mesgs">
